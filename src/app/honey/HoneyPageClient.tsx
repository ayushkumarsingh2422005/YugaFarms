...
export default function HoneyPageClient({ products }: { products: Product[] }) {
                    ...
                    <div key={product.id} className="rounded-xl md:rounded-2xl transition-all duration-300 group">
                      ...
                      <div className="p-2 md:p-4 space-y-2 md:space-y-3">
                          ...
                          >
                            {family.map((row) => {
                              ...
                              return (
                                ...
                                >
                                  {formatVariantUnit(row.weight, "Honey")} — ₹
                        ...
                        {family.length <= 1 && selected && (
                          <div className="flex items-center justify-between">
                            <span className="text-xs md:text-sm text-[#2D2D2D] font-bold">
                              {formatVariantUnit(selected.weight, "Honey")}
                            </span>
                            {savings > 0 && (
                        ...
                        <div className="flex items-center -mx-2 md:-mx-4 -mb-2 md:-mb-4 bg-white shadow-sm rounded-full">
                          ...
                          <button
                            type="button"
                            className="btn-atc btn-atc--compact rounded-r-full px-2 md:px-5 py-1.5 md:py-2.5 text-[10px] md:text-sm whitespace-nowrap"
                            onClick={() => {
                              if (selected) {
