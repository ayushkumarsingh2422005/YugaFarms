              ...
              {[
                {
                  ...
                  description: "Made from indigenous A2 cow milk, this ghee offers superior taste and nutritional benefits.",
                  rating: 4.9,
                  totalBuys: 2150,
                  originalPrice: 999,
                  currentPrice: 799,
                  ...
                  features: ["A2 Milk", "Bilona Churned", "Lab Tested", "No Preservatives"],
                  emoji: "🧈",
                ...
                },
                {
                  ...
                  description: "Our signature ghee made using the traditional bilona method, just like our grandmothers used to make.",
                  rating: 4.8,
                  totalBuys: 1890,
                  originalPrice: 899,
                  currentPrice: 699,
                  ...
                  features: ["Bilona Churned", "Pure Desi Cow", "Traditional Method", "Farm Fresh"],
                  emoji: "🐄",
                ...
                },
                {
                  ...
                  description: "Extra rich and creamy ghee made from pure buffalo milk, perfect for special occasions.",
                  rating: 4.7,
                  totalBuys: 1250,
                  originalPrice: 1099,
                  currentPrice: 899,
                  savings: 200,
                  weights: [
                    { value: "500g", price: 899, originalPrice: 1099 },
                    { value: "1kg", price: 1699, originalPrice: 2099 },
                    { value: "2kg", price: 3199, originalPrice: 3999 }
                  ],
                  features: ["Buffalo Milk", "Extra Rich", "Creamy Texture", "Premium Quality"],
                  emoji: "🥛",
                ...
                },
                {
                  ...
                  description: "Certified organic ghee made from grass-fed cows, free from chemicals and pesticides.",
                  rating: 4.8,
                  totalBuys: 980,
                  originalPrice: 1199,
                  currentPrice: 999,
                  savings: 200,
                  weights: [
                    { value: "500g", price: 999, originalPrice: 1199 },
                    { value: "1kg", price: 1899, originalPrice: 2299 },
                    { value: "2kg", price: 3599, originalPrice: 4399 }
                  ],
                  features: ["Certified Organic", "Grass Fed", "No Chemicals", "Eco Friendly"],
                  emoji: "🌿",
                  gradient: "from-[#2f4f2f] to-[#4b2e19]",
                  badge: "Organic"
                },
                {
                  ...
                  description: "Traditional ghee infused with aromatic spices like cardamom, cinnamon, and cloves.",
                  rating: 4.6,
                  totalBuys: 750,
                  originalPrice: 1299,
                  currentPrice: 1099,
                  savings: 200,
                  weights: [
                    { value: "500g", price: 1099, originalPrice: 1299 },
                    { value: "1kg", price: 2099, originalPrice: 2499 },
                    { value: "2kg", price: 3999, originalPrice: 4799 }
                  ],
                  features: ["Spice Infused", "Aromatic", "Traditional Blend", "Unique Flavor"],
                  emoji: "🌶️",
                  gradient: "from-[#8B4513] to-[#D2691E]",
                  badge: "Special"
                },
                {
                  title: "Family Pack Ghee",
                  subtitle: "Value Pack",
                  description: "Large family pack perfect for households, offering the best value for money.",
                  rating: 4.7,
                  totalBuys: 1650,
                  originalPrice: 1999,
                  currentPrice: 1599,
                  savings: 400,
                  weights: [
                    { value: "1kg", price: 1599, originalPrice: 1999 },
                    { value: "2kg", price: 2999, originalPrice: 3799 },
                    { value: "5kg", price: 6999, originalPrice: 8999 }
                  ],
                  features: ["Value Pack", "Family Size", "Cost Effective", "Bulk Savings"],
                  emoji: "👨‍👩‍👧‍👦",
                  gradient: "from-[#f5d26a] to-[#e6b800]",
                  badge: "Value"
                }
